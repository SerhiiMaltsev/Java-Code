...
public class Photo {
	 ...
	 */
	public Photo(String filename, String caption, int rating) {
		this.caption = caption;
		this.filename = filename;	
	...
	/** 
	 * Set the photo's rating if the value is in range [1, 5] and does not equal to the previous value
	 * 
	 ...
	 * @return returns true if two objects are equal and returns false if two objects are different
	 */
	...
	public static void main (String[] args) {
		Photo dog = new Photo("dog", "mydog.jpg", 3);
		...
		Photo cat = new Photo("cat", "fluffy.jpg", 1);
